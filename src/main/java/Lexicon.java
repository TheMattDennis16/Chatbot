...
public class Lexicon {
    ...
    private List<GrammarLine> grammars;
    private List<IntStringPair> words;
    private ALIEDB db;
    ...
    private List<Tuple> getTokenMiddle(int index, String[] sentenceWords, String[] grammarWords) {
        int toAdd = 0;
            ...
            for (int i = 0; i < sentenceWords.length; i++) {
                if (grammarWords[i].equals("*")) {
                    if (i + 1 == grammarWords.length) {
                        ...
                        List<Tuple> results = getTokenMiddle(i, sentenceWords, grammarWords);
                        if (results == null) {
                            isValid = false;
                            break;
                        }
